        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ->addColumn(
                    'action',
                    function ($item) {
                        return '<a class="inline-block border border-gray-700 bg-gray-700 text-white rounded-md px-2 py-1 m-1 transaction duration-500 ease select-none hover:bg-grey-800 focus:outline-none focus:shadow-outline" href="' . route('dashboard.category.edit', $item->id) . '" style="background-color: black">Edit</a>
